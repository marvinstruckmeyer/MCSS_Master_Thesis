...
# Prevent data variable conflicts
if (exists("data") && is.function(data)) {
  cat("⚠️ 'data' function exists - use 'analysis_data' for your dataset\n")
}
...
config <- list(
  ...
  output_dir = "UST_comprehensive_results_time_series_cross_validation",
  checkpoint_dir = "UST_comprehensive_checkpoints_time_series_cross_validation",
...
# Run single split
# =============================================================================
# HYPERPARAMETER TUNING FOR TIME SERIES CV
# =============================================================================
...
### feature importance
# Use fresh data loading to avoid conflicts

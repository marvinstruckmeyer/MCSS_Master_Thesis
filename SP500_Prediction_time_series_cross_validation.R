...
config <- list(
  ...
  output_dir = "SP_500_comprehensive_results_time_series_cross_validation",
  checkpoint_dir = "SP_500_comprehensive_checkpoints_time_series_cross_validation",
...
# function to extract feature importance from Time Series CV results
extract_best_models_and_importance <- function(all_results, data, target_col) {
  ...
  data_sorted <- data %>% dplyr::arrange(date)
...
library(dplyr) # to fix an issue with another package
